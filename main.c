...
void start()        // ฟังก์ชั่นเริ่มการทำงานของโปรแกรม
{
    int choice;
    while(1)
    {
...
// ฟังก์ชั่นแสดงรายชื่อที่บันทึกไว้
void list_record()
{
    system("cls");
    FILE *fp;
...
// ฟังก์ชั่นค้นหารายชื่อในด้วยเบอร์โทรศัพในกรณีที่ข้อมูลเรามีเยอะ
void search_person()
{
    system("cls");
    long int phone;
